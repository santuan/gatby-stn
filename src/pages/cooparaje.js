        ...
        <Fade duration={1750} delay={250}>
          <div className="relative w-full min-h-screen py-6 pt-6 mx-auto mt-2 md:mt-6">
            <InstantSearch searchClient={searchClient} indexName="recursos">
                    ...
                    translations={{
                      stats(
                        ...
                        return areHitsSorted && nbHits !== nbSortedHits
                          ? `${nbSortedHits.toLocaleString()} resultados ${nbHits.toLocaleString()} ${processingTimeMS.toLocaleString()}ms`
                          : `${nbHits.toLocaleString()} recursos encontrados`
                      },
                    }}
                  />
                </div>
              ...
              <div className="mt-12 mb-4 font-mono text-xs font-bold text-center text-indigo-100 md:text-sm">
              ...
              <div className="w-40 mx-auto mt-10 opacity-30">
