...
const RecursosPage = () => (
  <Layout>
    ...
    <Helmet>
      <body className="cooparaje fullpage" />
    </Helmet>
    <div className="z-20 flex flex-col items-center justify-center w-full min-h-screen text-center bg-pattern">
      <div className="relative z-50 flex flex-col items-center justify-center w-full px-2 py-4 mx-auto mt-2 ">
        <Fade duration={1750} delay={250}>
          <div className="relative grid w-full max-w-full gap-2 py-6 pt-6 mx-auto mt-2 sm:grid-cols-12 lg:min-h-screen md:mt-6">
            <InstantSearch searchClient={searchClient} indexName="recursos">
              <div className="flex flex-col items-center self-start justify-center w-full max-w-full mx-auto md:sticky sm:col-span-6 md:col-span-4 xl:col-span-3 top-6">
                <div className="w-full pt-0">
                  <div className="w-full px-4 overflow-auto md:max-h-[90vh] pt-2 pb-4 mx-auto bg-gray-900 rounded-xl">
                    <Fade bottom>
                      <h3 className="w-full max-w-md px-1 my-1 mb-2 font-serif text-lg text-left text-gray-100 md:text-xl">
                ...
                <div className="w-40 mx-auto mt-6 opacity-20">
              ...
              <div className="relative w-full max-w-full px-2 mx-auto sm:col-span-6 md:col-span-8 xl:col-span-9 2xl:px-6">
