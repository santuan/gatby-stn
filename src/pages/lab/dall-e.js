...
const DallePage = () => (
  <Layout>
    ...
    <Seo title="Dall-E" image="https://res.cloudinary.com/srcouto/image/upload/q_auto:eco/v1653960256/santuan/DALL_E_2022-05-27_22.39.14_unlacv.png" />
    <div className="flex flex-col justify-end w-full min-h-screen mx-auto text-center text-white bg-indigo-900">
      <div className="relative flex items-end justify-center w-full min-h-[40vh] pb-6 mx-auto overflow-hidden bg-gray-900/50 bg-opacity-30 bg-gradient-to-br from-emerald-700 to-indigo-600">
        <h1 className="relative z-10 flex items-center justify-center w-full px-4 mx-auto font-serif text-lg text-left md:text-3xl group max-w-7xl md:px-12">
          <Link
            to={`/galeria`}
